  ...
  return (
    <div className="p-6 space-y-6 bg-slate-50 min-h-screen">
      <div>
        ...
        <p className="text-xs text-slate-500">Queue trends, consultation times, and wait-time accuracy</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
          <span className="text-xs text-slate-500 font-semibold uppercase">Wait-time accuracy</span>
